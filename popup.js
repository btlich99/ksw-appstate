// Copyright 2024 KSWBADAIMWEEB. Đã đăng ký Bản quyền. MIT license.
            ...
            fr.onload = function (evt) {
                try {
                    ...
                    if (Array.isArray(j)) {
                        ...
                        toastNotification("Appstate imported successfully!");
                    } else {
    ...
    function exportFunc(encrypted) {
        chrome.cookies.getAll({
            ...
            btnCopy.onclick = function () {
                ...
                toastNotification('Success! The appstate was copied to your clipboard');
            };
            ...
            btnDownload.onclick = function () {
                ...
                a.click();
                toastNotification('Success! The appstate was downloaded ' + a.download);
                a.remove();
            };
        });
    }
